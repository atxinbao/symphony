...
- If more than one valid active issue is visible in the configured Linear project, Symphony treats
  it as a queue integrity error and skips dispatch for that polling tick.
